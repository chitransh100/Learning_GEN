...
json_schema = {
    ...
    "properties": {
        "keythemes": {
            "type": "array",
            "items": {"type": "string"},
            "description": "generate the key themes or the points discussed the in the review"
        },
        "summary": {
            "type": "string",
            "description": "generate a breif summary of the complete review"
        },
        "sentiment": {
            "type": "string",
            "enum": ["positive", "neg", "neutral"],
            "description": "tell me about the sentimento of teh review either good, bad or neutral"
        },
        "pros": {
            "type": "string",
            "description": "mention all teh pros if there"
        },
        "cons": {
            "type": "string",
            "description": "mention all teh cons if there"
        }
    },
