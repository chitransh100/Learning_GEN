...
class Review(TypedDict):
    keythemes: Annotated[list[str], "generate the key themes or the points discussed the in the review"]
    summary: Annotated[str, "generate a breif summary of the complete review"]
    sentiment: Annotated[Literal["positive", "neg", "neutral"], "tell me about the sentimento of teh review either good, bad or neutral"]
    pros: Annotated[Optional[str], "mention all teh pros if there"]
    cons: Annotated[Optional[str], "mention all teh cons if there"]
